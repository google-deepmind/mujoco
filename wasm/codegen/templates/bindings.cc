...
#include "third_party/mujoco/include/mjmodel.h"
#include "third_party/mujoco/include/mjvisualize.h"
...
EMSCRIPTEN_BINDINGS(mujoco_bindings) {
  ...
  emscripten::class_<MjLROpt>("MjLROpt")
      ...
      // INSERT-GENERATED-MjLROpt-BINDINGS
      ;
  ...
  emscripten::class_<MjvFigure>("MjvFigure")
      ...
      // INSERT-GENERATED-MjvFigure-BINDINGS
      ;
  ...
  emscripten::class_<MjsElement>("MjsElement")
      // INSERT-GENERATED-MjsElement-BINDINGS
      ;

  emscripten::class_<MjsCompiler>("MjsCompiler")
      // INSERT-GENERATED-MjsCompiler-BINDINGS
      ;
