...
EMSCRIPTEN_BINDINGS(mujoco_bindings) {
  ...
  emscripten::class_<MjModel>("MjModel")
    ...
    .property("layer_density", &MjModel::layer_density)
    .property("layer_gravity", &MjModel::layer_gravity)
    .property("layer_height", &MjModel::layer_height)
    .property("layer_viscosity", &MjModel::layer_viscosity)
    .property("layer_wind", &MjModel::layer_wind)
    ...
    .property("nactuator", &MjModel::nactuator, &MjModel::set_nactuator, reference())
    ...
    .property("nlayer", &MjModel::nlayer, &MjModel::set_nlayer, reference())
    ...
    .property("nout", &MjModel::nout, &MjModel::set_nout, reference())
