...
``/Applications/MuJoCo.app/Contents/Frameworks/mujoco.framework/Versions/Current/libmujoco.3.3.7.dylib`` (it can be
...
``~/.mujoco/mujoco-3.3.7/lib/libmujoco.so.3.3.7`` and rename it as ``libmujoco.so``.
