...
``/Applications/MuJoCo.app/Contents/Frameworks/mujoco.framework/Versions/Current/libmujoco.3.1.0.dylib`` (it can be
...
``~/.mujoco/mujoco-3.1.0/lib/libmujoco.so.3.1.0`` and rename it as ``libmujoco.so``.
