...
``/Applications/MuJoCo.app/Contents/Frameworks/mujoco.framework/Versions/Current/libmujoco.3.3.6.dylib`` (it can be
...
``~/.mujoco/mujoco-3.3.6/lib/libmujoco.so.3.3.6`` and rename it as ``libmujoco.so``.
