...
``/Applications/MuJoCo.app/Contents/Frameworks/mujoco.framework/Versions/Current/libmujoco.3.14.0.dylib`` (it can be
...
``~/.mujoco/mujoco-3.14.0/lib/libmujoco.so.3.14.0`` and rename it as ``libmujoco.so``.
