...
``/Applications/MuJoCo.app/Contents/Frameworks/mujoco.framework/Versions/Current/libmujoco.3.2.2.dylib`` (it can be
...
``~/.mujoco/mujoco-3.2.2/lib/libmujoco.so.3.2.2`` and rename it as ``libmujoco.so``.
