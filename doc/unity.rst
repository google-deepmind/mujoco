...
``/Applications/MuJoCo.app/Contents/Frameworks/mujoco.framework/Versions/Current/libmujoco.3.10.1.dylib`` (it can be
...
``~/.mujoco/mujoco-3.10.1/lib/libmujoco.so.3.10.1`` and rename it as ``libmujoco.so``.
