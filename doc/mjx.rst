...
`Warp JAX interoperability documentation <https://nvidia.github.io/warp/stable/user_guide/interoperability/jax.html>`__
...
.. [1] Differentiability is `mostly supported <https://github.com/google-deepmind/mujoco/issues/2259>`__ in MJX-JAX but is
       **not** currently available in MJX-Warp. See `Warp differentiability <https://nvidia.github.io/warp/stable/user_guide/differentiability.html>`__
       for more details.
