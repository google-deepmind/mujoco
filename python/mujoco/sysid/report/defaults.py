...
def default_report(
  ...
  if generate_videos:
    ...
    video_all_section = VideoPlayer(
      ...
      width="100%",
      height=None,
      caption="<span class='color-initial'>Initial</span>, <span class='color-nominal'>Nominal</span>, <span class='color-optimized'>Optimized</span>",
    )
    ...
    video_init_section = VideoPlayer(
      ...
      width="100%",
      height=None,
      caption="<span class='color-initial'>Initial</span>, <span class='color-nominal'>Nominal</span>",
    )
    ...
    video_opt_section = VideoPlayer(
      ...
      width="100%",
      height=None,
      caption="<span class='color-nominal'>Nominal</span>, <span class='color-optimized'>Optimized</span>",
    )
