...
typedef struct mjData_ {
  ...
  // AL contact state carried across steps (flag ipc); no mjtState spec covers it, so
  // mj_getState/mj_setState do not capture it and exact replay is not supported
