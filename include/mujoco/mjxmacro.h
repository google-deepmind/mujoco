...
// define symbols needed in MJMODEL_POINTERS (corresponding to number of
// columns)
...
#define MJMODEL_POINTERS_EXCLUDE X(int, exclude_signature, nexclude, 1)
...
#define MJDATA_POINTERS                                                        \
  ...
  X(mjtNum, wrap_length, nwrap, 1)                                             \
  X(mjtNum, wrap_entry, nwrap, 3)                                              \
  X(mjtNum, wrap_exit, nwrap, 3)                                               \
