...
// free-flight acceleration and the integrator computes the step
...
void mj_step(const mjModel* m, mjData* d) {
  ...
  // is the free-flight acceleration mj_IPC linearizes about, and mj_IPC runs the solves itself
  mj_forward(m, d);
  mj_checkAcc(m, d);
