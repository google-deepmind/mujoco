...
MjcPhysicsTokensType::MjcPhysicsTokensType()
    : affine("affine", TfToken::Immortal),
      allowed("allowed", TfToken::Immortal),
      ...
      mjcFlagSleep("mjc:flag:sleep", TfToken::Immortal),
      ...
      mjcGravcomp("mjc:gravcomp", TfToken::Immortal),
      ...
      mjcOptionSleep_tolerance("mjc:option:sleep_tolerance",
                                TfToken::Immortal),
      ...
      mjcSleep("mjc:sleep", TfToken::Immortal),
      ...
      MjcBodyAPI("MjcBodyAPI", TfToken::Immortal),
