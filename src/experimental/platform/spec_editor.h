...
#ifndef MUJOCO_SRC_EXPERIMENTAL_PLATFORM_SPEC_EDITOR_H_
#define MUJOCO_SRC_EXPERIMENTAL_PLATFORM_SPEC_EDITOR_H_
...
#endif  // MUJOCO_SRC_EXPERIMENTAL_PLATFORM_SPEC_EDITOR_H_
