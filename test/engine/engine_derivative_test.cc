...
class FlexAttachmentTest
 ...
 protected:
  ...
  void ExpectForce(const char* elasticity, bool damping) {
    ...
    EXPECT_GT(mju_norm(expected.data(), model->nv), 1e-7);
...
INSTANTIATE_TEST_SUITE_P(
    ...
    testing::Values(
        ...
        FlexAttachmentCase{"ReorderedSlides", R"(
                      <joint type="slide" axis="0 1 0"/><joint type="slide" axis="1 0 0"/>
...
<mujoco>
  <option solver="CG" integrator="discrete"/>
  <default><geom type="sphere" size=".01" mass=".1" contype="0" conaffinity="0"/></default>
  <worldbody>
    <body name="v0">
      <joint type="slide" axis="1 0 0"/><joint type="slide" axis="0 1 0"/>
      <joint type="slide" axis="0 0 1"/><geom/>
      <body pos=".02 0 0"><joint axis="0 1 0"/><geom pos=".1 0 0"/></body>
    </body>
  ...
  <deformable><flex dim="2" body="v0 v1 v2 v3" element="0 1 2 1 3 2">
    <contact selfcollide="none" contype="0" conaffinity="0"/>
