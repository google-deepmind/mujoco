...
auto Compare(char val1, char val2) { return val1 != val2; }

auto Compare(unsigned char val1, unsigned char val2) { return val1 != val2; }

auto Compare(bool val1, bool val2) { return val1 != val2; }
...
#define X(type, name, nr, nc)                                             \
  if (strncmp(#name, "bvh_", 4) && strncmp(#name, "flex_vert", 9) &&      \
      strncmp(#name, "mesh_poly", 9) && strcmp(#name, "flex_centered") && \
      strcmp(#name, "flex_size") && strcmp(#name, "flexedge_length0") &&  \
