...
namespace Mujoco {
  ...
  public struct MjJointSettings {
    ...
    public void ToMjcf(XmlElement mjcf) {
      mjcf.SetAttribute("armature", $"{Armature}");
      Spring.ToMjcf(mjcf);
      Solver.ToMjcf(mjcf);
    }
  }
  ...
  public struct SpringSettings {
    ...
    public void ToMjcf(XmlElement mjcf) {
      // Spring settings.
      mjcf.SetAttribute("springref", $"{EquilibriumPose}");
      mjcf.SetAttribute("springdamper", $"{TimeConstant} {DampingRatio}");
  ...
  public struct SolverImpedance {
    ...
    public void ToMjcf(XmlElement element, string attributeName) {
      element.SetAttribute(attributeName, $"{DMin} {DMax} {Width} {Midpoint} {Power}");
    }
  }
  ...
  public struct SolverReference {
    ...
    public void ToMjcf(XmlElement element, string attributeName) {
      element.SetAttribute(attributeName, $"{TimeConst} {DampRatio}");
    }
  }
  ...
  public struct SolverSettings {
    ...
    public void ToMjcf(XmlElement mjcf) {
      ...
      mjcf.SetAttribute("frictionloss", $"{FrictionLoss}");
      mjcf.SetAttribute("limited", $"{Limited}".ToLower());
      mjcf.SetAttribute("margin", $"{Margin}");
    }
