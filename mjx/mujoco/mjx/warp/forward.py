...
def _step_jax_impl(m: types.Model, d: types.Data):
  ...
  d = d.tree_replace({
      ...
      '_impl.cinert': out[19],
      '_impl.cqLD': out[20],
      '_impl.cqacc_smooth': out[21],
      '_impl.cqacc_warmstart': out[22],
      '_impl.cqfrc_smooth': out[23],
      '_impl.crb': out[24],
      '_impl.crhs': out[25],
      'cvel': out[26],
      '_impl.cx': out[27],
      '_impl.dof_awake_ind': out[28],
      '_impl.dof_cdof': out[29],
